    ...
    <div class="sidebar">
        <div class="logo"></div>
            <ul class="menu">
                ...
                <br>
                <li >
                    <a href="<?php echo base_url('/index.php/drivers/offers');?>">
                ...
                <br>
                <li >
                    <a href="<?php echo base_url('/index.php/drivers/historyTravelD');?>">
                ...
                <br>
                <li >
                    <a href="<?php echo base_url('/index.php/drivers/paysD');?>">
                ...
                <br>
                <li >
                    <a href="<?php echo base_url('/index.php/drivers/evaluationsD');?>">
